...
export default function Closing() {
  ...
  return (
    <section
      ref={ref}
      className="relative w-full min-h-screen bg-gradient-to-b from-slate-900 via-purple-900 to-slate-950 overflow-hidden flex items-center justify-center px-4 sm:px-8"
    >
      ...
      >
        ...
        >
          <div className="inline-block">
            ...
            <p className="text-xl sm:text-2xl font-cormorant italic text-amber-200">
              With All My Love,
            </p>
            <p className="text-2xl sm:text-3xl font-cormorant italic font-light text-amber-300 mt-2">
              Alsthom
            </p>
          </div>
        </motion.div>
      ...
      >
        <p className="text-sm sm:text-base font-inter text-slate-400">
          Made with love by Alsthom C. Pongan ✨
        </p>
