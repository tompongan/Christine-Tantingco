...
I love you always. ❤️`;
  ...
  return (
    <section ref={ref} className="relative min-h-screen w-full py-20 flex items-center justify-center bg-gradient-to-b from-white via-amber-50 to-white overflow-hidden px-4 sm:px-8">
        ...
        <div className="glass rounded-3xl p-8 sm:p-12 lg:p-16 glow-gold">
          ...
          >
            {letterText.split('\n\n').map((paragraph, idx) => (
              <p
                key={idx}
                className="text-base sm:text-lg font-inter text-slate-800 leading-relaxed tracking-wide"
              >
                {paragraph}
              </p>
            ))}
